  ...
  <ActionSection>
    ...
    <template #content>
          ...
          <div class="ms-3">
            ...
            <div>
              <div class="text-xs text-gray-500">
                ...
                <span v-if="session.is_current_device" class="font-semibold text-green-500">{{ $t('This device') }}</span>
      ...
      <div class="mt-5 flex items-center">
        <PrimaryButton @click="confirmLogout"> {{ $t('Log Out Other Browser Sessions') }} </PrimaryButton>

        <ActionMessage :on="form.recentlySuccessful" class="ms-3"> {{ $t('Done.') }} </ActionMessage>
      </div>
